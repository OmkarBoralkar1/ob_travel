...
const Detailscontent = () => {
    ...
    value={newContent || (detailContentImg.content || '')} // Provide a default empty string
    onChange={setNewContent} // Use the `setNewContent` function to update the state
    readOnly={contentDisabled}
    required
    rows="8"
    cols="40"
    className={styles.box2 && styles['detailcontent-blogcontent']}
/>
                            <Link
